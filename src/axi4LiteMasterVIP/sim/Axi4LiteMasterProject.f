...
+incdir+$AXI4LITE_MASTER/src/tb/test/
...
$(AXI4LITE_MASTER)/src/tb/virtualSequences/Axi4LiteMasterVirtualSeqPkg.sv
$(AXI4LITE_MASTER)/src/tb/test/Axi4LiteMasterTestPkg.sv
$(AXI4LITE_MASTER)/src/tb/Axi4LiteMasterInterface.sv

$(AXI4LITE_MASTER)/src/tb/Axi4LiteMasterHdlTop.sv
$(AXI4LITE_MASTER)/src/tb/Axi4LiteMasterHvlTop.sv
